...
def parse_entry(entry: dict) -> Conditions:
    ...
    result = Conditions(
        ...
        temperature_p10=instant.get('air_temperature_percentile_10'),
        temperature_p90=instant.get('air_temperature_percentile_90'),
        wind_speed=instant.get('wind_speed'),
        wind_gust=instant.get('wind_speed_of_gust'),
        wind_speed_p10=instant.get('wind_speed_percentile_10'),
        wind_speed_p90=instant.get('wind_speed_percentile_90'),
